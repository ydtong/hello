...
@Getter
@Setter
public class LongVirtualNumberFreeSubPageResult {
    ...
    public LongVirtualNumberFreeSubPageResult() {
    }

    public LongVirtualNumberFreeSubPageResult(VirtualNumberMysqlEntity virtualNumberMysqlEntity) {
