...
@Getter
@Setter
public class LongVirtualNumberBindingSubPageResult {
    ...
    public LongVirtualNumberBindingSubPageResult() {
    }

    public LongVirtualNumberBindingSubPageResult(VirtualNumberMysqlEntity virtualNumberMysqlEntity) {
