...
import com.allqj.virtual_number_administrate.business.microService.longHiddencall.inte.LongService;
...
@Service("longVirtualNumberUserServiceImpl")
@AddLog
@UseDistributedLocks
public class LongVirtualNumberUseServiceImpl implements IVirtualNumberUseService {
    ...
    @Autowired
    private LongService longServiceClient;
    ...
    public BindingVirtualNumberResult binding(BindingVirtualNumberRequest bindingVirtualNumberRequest) {
        ...
        //调用基础服务
        LongBindingRequest longBindingRequest = new LongBindingRequest(
                bindingVirtualNumberRequest.getVirtualNumber(),
                bindingVirtualNumberRequest.getPhone(),
                bindingVirtualNumberRequest.getName(),
                bindingVirtualNumberRequest.getCardno()
        );
        ResultVO<LongBindingResult> clientResult = longServiceClient.binding(longBindingRequest);
        if (clientResult.getResult() == null)
    ...
    public Boolean cancelBinding(CancelBindingVirtualNumberRequest cancelBindingVirtualNumberRequest) {
        ...
        //解绑
        ResultVO<Boolean> result = longServiceClient.cancelBinding(cancelBindingVirtualNumberRequest.getVirtualNumber());
    ...
    public CallVirtualNumberResult calls(CallReqest callVirtualNumberRequest) {
        ...
        //拨打
        ResultVO<CallResult> result = longServiceClient.call(callVirtualNumberRequest);
        if (result.getResult() == null)
